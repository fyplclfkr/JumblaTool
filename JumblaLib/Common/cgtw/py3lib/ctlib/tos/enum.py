...
def convert_storage_class_type(storage_class):
...
def convert_metadata_directive_type(s):
...
def convert_az_redundancy_type(s):
...
def convert_storage_class_inherit_directive_type(s):
...
def convert_versioning_status_type(s):
