...
class TosClient(object):
    ...
    def generate_presigned_url(self, Method, Bucket=None, Key=None, Params=None, ExpiresIn=None):
        """
        生成带签名的url
        :param: Bucket: 桶名
        :param: Key: 对象名
    ...
    def create_bucket(self, Bucket, ACL=None, GrantFullControl=None, GrantRead=None, GrantReadACP=None,
                      GrantWrite=None, GrantWriteACP=None):
        """
        创建bucket
        :param Bucket: 桶名
    ...
    def list_objects(self, Bucket, Delimiter=None, EncodingType=None, Marker=None, MaxKeys=None, Prefix=None):
        """
        列举对象
        :param Bucket: 桶名
    ...
    def list_object_versions(self, Bucket, Delimiter=None, EncodingType=None, KeyMarker=None, MaxKeys=None,
                             Prefix=None, VersionIdMarker=None):
        """
        列举多版本对象
        :param Bucket: 桶名
        :param Delimiter: 分隔符
    ...
    def list_multipart_uploads(self, Bucket, Delimiter=None, EncodingType=None, KeyMarker=None, MaxUploads=None,
                               Prefix=None, UploadIdMarker=None):
        """
        列举正在进行中的分片任务
        :param Bucket: 桶名
        :param Delimiter: 目录分隔符
    ...
    def create_multipart_upload(self, Bucket, Key, ACL=None, CacheControl=None, ContentDisposition=None,
                                ContentEncoding=None, ContentLanguage=None, ContentType=None, Expires=None,
                                GrantFullControl=None, GrantRead=None, GrantReadACP=None, GrantWriteACP=None,
                                Metadata=None, SSECustomerAlgorithm=None, SSECustomerKey=None, SSECustomerKeyMD5=None):
        """
        初始化分片上传
        :param Bucket: 桶名
        :param Key: 对象名
    ...
    def upload_part(self, Bucket, Key, PartNumber, UploadId, Body=None):
        """
        上传分片
        :param Bucket: 桶名
        :param Key: 对象名
    ...
    def upload_part_copy(self, Bucket, CopySource, Key, PartNumber, UploadId, CopySourceIfMatch=None,
    ...
    def complete_multipart_upload(self, Bucket, Key, UploadId, MultipartUpload=None):
        """
        合并分片
        :param Bucket: 桶名
        :param Key: 对象名
    ...
    def put_object(self, Bucket, Key, ACL=None, Body=None, CacheControl=None, ContentDisposition=None,
                   ContentEncoding=None, ContentMD5=None, ContentLanguage=None, ContentType=None, Expires=None,
                   GrantFullControl=None, GrantRead=None, GrantReadACP=None, GrantWriteACP=None, Metadata=None,
    ...
    def get_object(self, Bucket, Key, IfMatch=None, IfModifiedSince=None, IfNoneMatch=None, IfUnmodifiedSince=None,
    ...
    def head_object(self, Bucket, Key, IfMatch=None, IfModifiedSince=None, IfNoneMatch=None, IfUnmodifiedSince=None,
    ...
    def copy_object(self, Bucket, CopySource, Key, ACL=None, CacheControl=None, ContentDisposition=None,
                    ContentEncoding=None, ContentLanguage=None, ContentType=None, CopySourceIfMatch=None,
                    CopySourceIfModifiedSince=None, CopySourceIfNoneMatch=None, CopySourceIfUnmodifiedSince=None,
                    Expires=None, GrantFullControl=None, GrantRead=None, GrantReadACP=None, GrantWriteACP=None,
                    Metadata=None, MetadataDirective=None, SSECustomerAlgorithm=None, SSECustomerKey=None,
    ...
    def append_object(self, Bucket, Key, Offset, ACL=None, Body=None, CacheControl=None, ContentDisposition=None,
                      ContentEncoding=None, ContentMD5=None, ContentLanguage=None, ContentType=None, Expires=None,
                      GrantFullControl=None, GrantRead=None, GrantReadACP=None, GrantWriteACP=None, Metadata=None,
                      SSECustomerAlgorithm=None, SSECustomerKey=None, SSECustomerKeyMD5=None):
        """
    ...
    def put_object_acl(self, Bucket, Key, ACL=None, AccessControlPolicy=None, GrantFullControl=None, GrantRead=None,
                       GrantReadACP=None, GrantWrite=None, GrantWriteACP=None, VersionId=None):
        """
        设置对象acl
        :param Bucket: 桶名
        :param Key: 对象名
    ...
    def set_object_metadata(self, Bucket, Key, ObjectMetadata={}):
        """
        设置对象元数据
        :param Bucket: 桶名
        :param Key: 对象名
