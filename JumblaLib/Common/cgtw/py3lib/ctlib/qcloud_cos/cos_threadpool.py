...
class WorkerThread(Thread):
    def __init__(self, task_queue, flag_dict, *args, **kwargs):
    ...
    def run(self):
        while True:
            ...
            #print self._flag_dict
            if hasattr(self, "_flag_dict") and isinstance(self._flag_dict, dict) and self._flag_dict["is_pause"]==True:
...
class SimpleThreadPool:
    ...
    def __init__(self, num_threads=5, num_queue=0, flag_dict={}):
            ...
            with self._lock:
                if not self._active:
                    ...
                    for i in range(self._num_threads):
                        w = WorkerThread(self._queue, self._flag_dict)
