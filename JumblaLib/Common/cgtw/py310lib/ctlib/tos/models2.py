...
class Deleted(object):
    def __init__(self, key, version_id=None, delete_marker=None,
...
class DeleteError(object):
    def __init__(self, key, version_id, code, message):
        self.key = key
        self.version_id = version_id
        self.code = code
...
class Grantee(object):
    def __init__(self, type, id=None, display_name=None, canned=None):
        self.type = type
        self.display_name = display_name
        self.id = id
        self.canned = canned
...
class HeadObjectOutput(ResponseInfo):
    def __init__(self, resp):
        ...
        if content_dis_str:
            self.content_disposition = unquote(get_value(resp.headers, "content-disposition"))
        else:
...
class ListedObjectVersion(ListedObject):
    def __init__(self, key, last_modified, etag, size, storage_class,
                 hash_crc64_ecma, owner=None, version_id=None, is_latest=None):
...
class GetObjectOutput(HeadObjectOutput):
    def __init__(self, resp, progress_callback=None, rate_limiter=None, discard=0):
...
class ListedUpload(object):
    def __init__(self, key, upload_id, storage_class, initiated,
                 owner=None):
        self.key = key
...
class Condition(object):
    def __init__(self, http_code=None, key_prefix=None, key_suffix=None):
...
class ReplaceKeyPrefix(object):
    def __init__(self, key_prefix=None, replace_with=None):
        self.key_prefix = key_prefix
        self.replace_with = replace_with


class Transform(object):
    def __init__(self, with_key_prefix=None, with_key_suffix=None,
...
class PublicSource(object):
    def __init__(self, source_endpoint=None, fixed_endpoint=None):
        self.source_endpoint = source_endpoint
        self.fixed_endpoint = fixed_endpoint


class MirrorHeader(object):
    def __init__(self, pass_all=None, pass_headers=None, remove=None):
...
class Redirect(object):
    def __init__(self, redirect_type=None, public_source=None,
                 fetch_source_on_redirect=None, pass_query=None, follow_redirect=None,
                 mirror_header=None, transform=None):
...
class Rule(object):
    def __init__(self, id=None, condition=None, redirect=None):
        self.id = id
...
class UploadFileOutput(object):
    def __init__(self, resp, ssec_algorithm, ssec_key_md5, upload_id, encoding_type):
        self.request_id = resp.request_id
        self.id2 = resp.id2
...
class BucketLifeCycleNonCurrentVersionTransition(object):
    def __init__(self, storage_class=None, non_current_days=None):
        self.storage_class = storage_class
...
class BucketLifeCycleRule(object):
    ...
    def __init__(self, status=None,
                 expiration=None,
                 no_current_version_expiration=None,
                 abort_in_complete_multipart_upload=None,
                 tags=None,
                 transitions=None,
...
class Destination(object):
    def __init__(self, bucket=None, location=None, storage_class=None,
...
class Progress(object):
    def __init__(self, historical_object, new_object):
        self.historical_object = historical_object
        self.new_object = new_object


class ReplicationRule(object):
    def __init__(self, id=None, status=None, prefix_set=None,
                 destination=None,
                 historical_object_replication=None, progress=None):
        self.id = id
        self.status = status
...
class IndexDocument(object):
    def __init__(self, suffix=None, forbidden_sub_dir=None):
        self.suffix = suffix
...
class RoutingRuleRedirect(object):
    def __init__(self, protocol=None, host_name=None, replace_key_prefix_with=None,
...
class RocketMQConf(object):
    def __init__(self, instance_id=None, topic=None, access_key_id=None):
...
class CloudFunctionConfiguration(object):
    def __init__(self, id=None, events=None, filter=None, cloud_function=None):
        self.id = id
        self.events = events
        self.filter = filter
...
class RocketMQConfiguration(object):
    def __init__(self, id=None, events=None, filter=None, role=None,
                 rocket_mq=None):
        self.id = id
        self.events = events
        self.filter = filter
...
class CustomDomainRule(object):
    def __init__(self, cert_id=None, cert_status=None, domain=None, cname=None,
                 forbidden=None, forbidden_reason=None):
...
class AccessLogConfiguration(object):
    def __init__(self, use_service_topic=None, tls_project_id=None, tls_topic_id=None):
...
class RealTimeLogConfiguration(object):
    def __init__(self, role=None, configuration=None):
        self.role = role
...
class ResumableCopyObjectOutput(object):
    def __init__(self, resp, ssec_algorithm, ssec_key_md5, encoding_type):
        self.request_id = resp.request_id
        self.id2 = resp.id2
        self.status_code = resp.status_code
        self.header = resp.header
...
class PreSignedPolicyURlInputOutput(object):
    ...
    def get_signed_url_for_list(self, additional_query=None):
    ...
    def get_signed_url_for_get_or_head(self, key, additional_query=None):
        if additional_query is None:
