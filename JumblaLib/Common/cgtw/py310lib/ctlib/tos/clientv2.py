...
def _get_create_bucket_headers(ACL, AzRedundancy, GrantFullControl, GrantRead, GrantReadACP, GrantWrite, GrantWriteACP,
                               StorageClass):
    headers = {}
    if ACL:
...
def _get_copy_object_headers(ACL, CacheControl, ContentDisposition, ContentEncoding, ContentLanguage,
                             ...
                             website_redirect_location, storage_class,
    ...
    if isinstance(CopySource, str):
        ...
        copy_source = CopySource['Bucket'] + '/' + url_quote(CopySource['Key'], '/~')
    ...
    if ContentDisposition:
        headers['content-disposition'] = url_quote(ContentDisposition)
    if ContentEncoding:
...
def _get_object_params(ResponseCacheControl, ResponseContentDisposition, ResponseContentEncoding,
    ...
    if ResponseContentDisposition:
        params['response-content-disposition'] = url_quote(ResponseContentDisposition)
...
def _get_set_object_meta_headers(recognize_content_type, cache_control, content_disposition, content_encoding,
    ...
    if content_disposition:
        headers['content-disposition'] = url_quote(content_disposition)
    if content_encoding:
...
def _valid_upload_checkpoint(bucket, store, key, modify_time, part_size):
...
def _valid_download_checkpoint(bucket, store, key, etag, part_size, version_id):
    if os.path.exists(store.path(bucket, key)):
...
def _valid_copyobject_checkpoint(bucket, store, key, etag, part_size, src_bucket=None,
                                 src_key=None, version_id=None):
...
class TosClientV2(TosClient):
    ...
    def pre_signed_url(self, http_method, bucket,
                       key=None,
                       expires=3600,
                       header=None,
                       query=None,
    ...
    def pre_signed_policy_url(self, bucket, conditions=None,
                              expires=3600,
                              alternative_endpoint=None,
                              is_custom_domain=False):
    ...
    def copy_object(self, bucket, key, src_bucket, src_key,
                    src_version_id=None,
                    cache_control=None,
                    ...
                    copy_source_ssec_algorithm=None,
                    copy_source_ssec_key=None,
                    copy_source_ssec_key_md5=None,
    ...
    def delete_multi_objects(self, bucket, objects, quiet=False):
        """批量删除对象
    ...
    def put_object_acl(self, bucket, key,
                       version=None,
                       acl=None,
                       grant_full_control=None,
                       grant_read=None,
    ...
    def append_object(self, bucket, key, offset,
                      content=None,
                      content_length=None,
                      cache_control=None,
                      content_disposition=None,
    ...
    def set_object_meta(self, bucket, key,
                        version_id=None,
                        cache_control=None,
                        content_disposition=None,
                        content_encoding=None,
    ...
    def get_object_to_file(self, bucket, key, file_path,
                           version_id=None,
                           if_match=None,
                           if_modified_since=None,
                           if_none_match=None,
    ...
    def resumable_copy_object(self, bucket, key, src_bucket, src_key,
                              encoding_type=None,
                              cache_control=None,
                              content_disposition=None,
                              content_encoding=None,
    ...
    def upload_part_from_file(self, bucket, key, upload_id, part_number,
                              content_md5=None,
                              ssec_algorithm=None,
                              ssec_key=None,
                              ssec_key_md5=None,
    ...
    def upload_part_copy(self, bucket, key, upload_id, part_number, src_bucket, src_key,
                         src_version_id=None,
                         copy_source_range_start=None,
                         copy_source_range_end=None,
                         copy_source_if_match=None,
                         copy_source_if_modified_since=None,
                         copy_source_if_none_match=None,
                         copy_source_if_unmodified_since=None,
    ...
    def put_bucket_cors(self, bucket, cors_rule):
        """ 为指定桶设置跨域请求配置
    ...
    def list_objects_type2(self, bucket,
                           prefix=None,
                           delimiter=None,
                           start_after=None,
    ...
    def put_bucket_storage_class(self, bucket,
                                 storage_class):
        """ 设置 bucket 的存储类型
    ...
    def put_bucket_mirror_back(self, bucket, rules):
        """ 设置 bucket 的镜像回源规则
    ...
    def get_bucket_mirror_back(self, bucket):
        """ 获取 bucket 的镜像回源规则
    ...
    def delete_bucket_mirror_back(self, bucket):
        """ 删除 bucket 的镜像回源规则
    ...
    def put_object_tagging(self, bucket, key, tag_set,
                           version_id=None):
        """ 为 object 添加标签
    ...
    def fetch_object(self, bucket, key, url,
                     acl=None,
                     grant_full_control=None,
                     grant_read=None,
                     grant_read_acp=None,
    ...
    def put_fetch_task(self, bucket, key, url,
                       acl=None,
                       grant_full_control=None,
                       grant_read=None,
                       grant_read_acp=None,
    ...
    def put_bucket_replication(self, bucket, role,
                               rules):
        """ 设置桶的跨区域复制规则
    ...
    def get_bucket_version(self, bucket):
        """ 获取桶的多版本状态
    ...
    def put_bucket_website(self, bucket,
    ...
    def put_bucket_notification(self, bucket, cloud_function_configurations=None,
    ...
    def get_bucket_notification(self, bucket):
        """
    ...
    def put_bucket_custom_domain(self, bucket, rule):
        """ 设置自定义域名
    ...
    def list_bucket_custom_domain(self, bucket):
        """ 列举自定义域名
    ...
    def delete_bucket_custom_domain(self, bucket, domain):
        """ 删除自定义域名
    ...
    def put_bucket_real_time_log(self, bucket, configuration):
    ...
    def get_bucket_real_time_log(self, bucket):
        """ 获取实时日志
    ...
    def delete_bucket_real_time_log(self, bucket):
        """ 删除桶实时日志配置
    ...
    def restore_object(self, bucket, key, days, version_id=None,
    ...
    def rename_object(self, bucket, key, new_key):
        """ 重命名对象
        :param bucket: 桶名
        :param key: 对象名
        :param new_key: 新对象名
    ...
    def get_bucket_rename(self, bucket):
    ...
    def put_bucket_rename(self, bucket, rename_enable):
        """ 设置开启rename功能
        :param bucket: 桶名
    ...
    def delete_bucket_rename(self, bucket):
        """ 删除桶rename功能
        :param bucket: 桶名
...
def _handler_retry_policy(body, method, fun_name, client_exp=None,
                          server_exp=None, skip=False):
    logger.info(
